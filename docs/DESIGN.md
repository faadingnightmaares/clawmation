...
- **Sans** `Inter`: *everything.* Display titles at 700 / -0.022em tracking;
  section labels at 600 / uppercase / `.11em`; body at 400 to 500. The serif
...
5. **Speak in human units.** "Repeat: Until I stop," not "count = 0." "Playback
   speed: Slower · Normal · Faster," not "0.2× to 25×." "Loose · Normal ·
   Strict," not a 0.0 to 1.0 threshold.
...
| "Playback speed: Slower · Normal · Faster" | "0.2× to 25× speed multiplier" |
